            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-striped table-hover table-condensed">
                    <tr>
                        ...
                        <th><a href="?page={{ $data['comments']->currentPage() }}&order=company_id&dir={{ $data['dir'] ? $data['dir'] : 'asc' }}{{ $data['searchText'] ? '&searchText='.$data['searchText'] : '' }}">В адрес компании</a>{!! $data['page_appends']['order'] == 'company_id' ? $data['dir'] == 'desc' ? '<span class="glyphicon glyphicon-arrow-down"></span>' : '<span class="glyphicon glyphicon-arrow-up"></span>' : '' !!}</th>
