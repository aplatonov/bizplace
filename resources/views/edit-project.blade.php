                            ...
                            <div class="col-md-6">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-xs-6">
                                            <label for="budget">Бюждет</label>
                                            <input type="text" class="form-control" id="budget" name="budget" value="{{ $project->budget }}" onkeyup="this.value = this.value.replace (/\D/g, '')">
                                            @if ($errors->has('budget'))
                                                <span class="text-danger">
                                                    <strong><small>{{ $errors->first('budget') }}</small></strong>
                                                </span>
                                            @endif
                                        </div>
