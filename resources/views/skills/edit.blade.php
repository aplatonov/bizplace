...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> Редактирование уровня</li>
    </ol>
@stop
         ...
         <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Редактирование уровня</h3>
                </div><!-- /.box-header -->
                <form role="form" method="POST" action="{{ route('skills.update', $skill->id) }}">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <div class="checkbox">
                                                <label for="active">
                                                    <input type="checkbox" id="active" name="active" {{ $skill->active ? 'checked' : ''}} value="1">
                                                    Активно
                                                </label>
