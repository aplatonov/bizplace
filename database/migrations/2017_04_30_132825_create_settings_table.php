...
class CreateSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('settings', function (Blueprint $table) {
            ...
            $table->text('how_it_works_3')->nullable()->default(null);
            ...
            $table->string('regime', 150)->nullable()->default(null);
            $table->text('about_us_1')->nullable()->default(null);
            $table->text('about_us_2')->nullable()->default(null);
            $table->text('about_us_3')->nullable()->default(null);
            $table->text('konfedential')->nullable()->default(null);
